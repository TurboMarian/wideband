...
#ifndef LL_GPIO_PIN_UNUSED
#define LL_GPIO_PIN_UNUSED ((uint32_t)0xFFFFFFFFU)
#endif

// Communication - UART
#define UART_GPIO_PORT				GPIOA
#define LL_UART_TX_PIN				LL_GPIO_PIN_UNUSED
#define LL_UART_RX_PIN				LL_GPIO_PIN_UNUSED
...
// PB1 TIM3_CH4
#define PUMP_DAC_PWM_DEVICE PWMD2
#define PUMP_DAC_PWM_CHANNEL_1 4
